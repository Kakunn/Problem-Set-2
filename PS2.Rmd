---
title: "The correlation between household size and life satisfaction"
...
##### The model used here is a mutiple linear regression model: feelings_life = 7.69396 + 0.61378x1 + 0.40607x2 + 0.54916x3 + 0.52602x4 + 0.67527x5. It is generated by using R.
...
##### The variable "household_size" is treated as a categorical variable because household_size is not continuous and its data is more like a type than a number. Moreover, by splitting the data into 5 dummy variables, it is easier to compare and interpret the mean difference of life satisfaction scores between different sizes of households.
...
#### 2. Sam Firke (2020). janitor: Simple Tools for Examining and Cleaning Dirty Data. R package version 2.0.1. https://CRAN.R-project.org/package=janitor

#### 3. Laine Ruus. (2017). General social survey on Family (cycle 31), 2017. https://sda-artsci-utoronto-ca.myaccess.library.utoronto.ca/cgi-bin/sda/hsda?harcsda4+gss31

#### 4. Pascale Beaupré. (2020, April). Cycle 31 : Families Public Use Microdata File Documentation and User’s Guide. Retrieved October 18, 2020, from https://sda-artsci-utoronto-ca.myaccess.library.utoronto.ca/sdaweb/dli2/gss/gss31/gss31/more_doc/GSS31_User_Guide.pdf

#### 5. Morgan, M. (2017, March 03). Study finds larger families have highest overall life satisfaction. Retrieved October 18, 2020, from https://www.reviewjournal.com/life/study-finds-larger-families-have-highest-overall-life-satisfaction/